            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register-details.store') }}">
                        ...
                        {{-- البريد الإلكتروني --}}
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">البريد الإلكتروني (اختياري)</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text"
                                       ...
                                       name="address" value="{{ old('address') }}" required placeholder="مثلاً: شارع التحرير، الدور الثالث">
                                @error('address')
                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <small class="text-muted">يمكنك سحب العلامة لتحديد موقعك بدقة أو النقر على الخريطة.</small>
                            </div>
                        </div>
